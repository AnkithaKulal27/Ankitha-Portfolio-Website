...
const Contact = () => {
  return (
    <section id="contact"  className="px-10 py-25 flex flex-col gap-6">
        <motion.h1 
        ...
        <div className="items-center justify-center flex flex-col gap-5">
            ...
            <h5 className="text-gray-300 tracking-wide">ankithakulal57@gmail.com</h5>
            <p className="text-gray-300 tracking-wide">Perdoor,Udupi,Karnataka</p>
        </div>
    </section>
  )
}
